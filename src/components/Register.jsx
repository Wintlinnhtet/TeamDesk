...
//   const userId = user._id;  // ✅ highlight
...
//   // Fetch existing user data to prefill form (optional)
//   useEffect(() => {
//     if (!userId) {
...
//             Registration Form
//           </span>
//           <span className="font-light text-center text-gray-400 mb-8">Please enter your details</span>
